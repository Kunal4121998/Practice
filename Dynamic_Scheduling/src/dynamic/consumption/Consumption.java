...
public class Consumption {
	...
	public void getData() throws NumberFormatException, FilloException{
		int z=0; 
	       ...
	       Connection connection=fillo.getConnection("C:\\Users\\KUNAL\\Desktop\\ds\\ConsumptionFile.xlsx");
		int i1;
		int y;
		...
		while(recordset.next()){
			...
			Model2 model2=new Model2(recordset.getField("Plant"),recordset.getField("Posting Date"),recordset.getField("Material"),b,z++);
                    list.add(model2);
